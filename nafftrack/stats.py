...
cache_limits_soft = Gauge(
    "naff_cache_soft_limits", "Soft limits on the caches", labelnames=["name"]
)
cache_limits_hard = Gauge(
    "naff_cache_hard_limits", "Hard limits on the caches", labelnames=["name"]
)
